...
3. Genera output in formato tree visuale:
   ...
   ├── technical/
   │   ├── tech-debt.md [Utility] [Template/Complete — /dev-refactor]
   │   ├── quality-report.md [Utility] [Generated by /dev-refactor]
   │   ├── security-report.md [Utility] [Generated by /dev-security]
   │   └── ...
   └── sprint-reviews/
